...
INSERT INTO `dzm_his_doctors` VALUES ('2', '当时发', '140000', null, '$2y$12$n97x7Fue6SddXflXIPYO9.2hUli2gTMM96LdAuluI5fjSklVCeYXW', '0', '13141589203', '登山泛水', '', '医生', '0527', '83856745', '1543045946', '1543053462', '0', '0.00');
...
-- ----------------------------
INSERT INTO `dzm_his_hospital` VALUES ('1', '雪狼', '', '1511947869', '', '0', '1', '', '雪狼', '', '', '', '');
...
-- ----------------------------
INSERT INTO `dzm_his_member` VALUES ('1', 'admin', '$2y$12$GMjNyRp3T48Dkv/rPySg7O7jgMqYJ7hP4QrTHO6JFl4BeHLBCmh3S', '0', null, '1511947869', '1', '0', '1', '0', '0', '0', '', '0.00', '0.00', '', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='我的排班';
...
CREATE TABLE `dzm_his_scheduling_subsection` (
  ...
  KEY `scheduling_id` (`scheduling_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='排班时段表';
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='排班星期表';
