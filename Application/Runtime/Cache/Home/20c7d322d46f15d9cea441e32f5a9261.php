	...
	<div class="main-box J_MainBox">
		...
		<div class="form-container doctor-register-suc">
			<form id="userForm" name="userForm" method="post" action="">
				<div class="top-tips">
					<p class="success-tips"><span class="blue-text">注册成功，李旭峰医生欢迎加入微医，微医因你更精彩！</span></p>
				</div>
				<p class="middle-tips">您的账号是<span class="account">13776848129</span>&nbsp;&nbsp;此账号可同时登录微医，微医生APP</p>
				<a class="btn btn-success btn-lg enter-home" href="<?php echo U('home/index/doctorhome');?>">进入微医生</a>
				<div class="bottom-info g-clear">
					...
					<div class="g-left">
						<p>扫码下载“微医生”客户端，微医生，<br/>品牌医生的移动诊室！</p>
					</div>
				</div>
			</form>
		</div>
